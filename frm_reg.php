...
$ControlNames=array("username"	=>array("''" =>"กรุณากรอกข้อมูล USERNAME"),
					...
					"address"	=>array("''" =>"กรุณาใส่ข้อมูลที่อยู่ ")
					);
...
VALUES (
'$_POST[username] ', '$_POST[password]', '$_POST[name]', '$_POST[address]', '$_POST[email]', '$_POST[identily]  ', '$_POST[tel]','$_POST[Branch]'
);
";
	mysql_query($q);
	echo "ได้ลงทะเบียนสาขาใหม่แล้ว";
	exit;
    ...
    <tr>
      <td><h1>สาขาใหม่</h1>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
			...
			<tr>
              <td><div align="right"><strong>สาขา<br />
                <span class="small">สาขาย่อย</span></strong></div></td>
              <td><div align="left">
                <input name="Branch" type="text" id="Branch" />
              <span class="smallstar">ตัวอย่าง สาขาพญาไท3</span></div></td>
            </tr>
